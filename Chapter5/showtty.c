...
int main()
{
	...
	printf("The line kill character is ascii %d, Crtl-%c\n",
...
/*
 * show the values of two of the flag sets_: c_flag and c_lflag
 * adding c_oflag and c_cflag is pertty routine - just add new
